<%@ Page Title="Edit Room" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditRoom.aspx.cs" Inherits="HotelManagerReservationsPt3.Views.Admin.EditRoom" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" ID="EditRoomButton" OnClick="EditRoomButton_Click" Text="Edit Room" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>

<%@ Page Title="Edit Reservation" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditReservation.aspx.cs" Inherits="HotelManagerReservationsPt3.Views.User.EditReservation" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" ID="EditReservationButton" OnClick="EditReservationButton_Click" Text="Edit" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
